...
impl<'de> Deserialize<'de> for SealAttributes {
            ...
            D: Deserializer<'de>,
    {
        ...
        println!("raw data in deserialize: {:?}", raw_data);
...
impl<'de> Deserialize<'de> for SealMiscselect {
            ...
            D: Deserializer<'de>,
    {
        ...
        if let Some(misc) = Miscselect::from_bits(bits) {
            ...
            Err(de::Error::custom( format!("deserilize Miscselect from {} failed", bits)))
        }
    }
}
...
fn egetkey(label: Label, seal_data: &SealData)
           -> Result<EgetKey, Error>
{
...
/// downgraded.
pub fn unseal_key(label: Label, seal_data: &SealData)
                  -> Result<EgetKey, Error>
{
    let report = Report::for_self();
